...
<%@ page import="com.laponhcet.itemcategory.*" %>

<%
SessionInfo sessionInfo = (SessionInfo) session.getAttribute(SessionInfo.SESSION_INFO);
DataTable dataTable = (DataTable) session.getAttribute(ItemCategoryDTO.SESSION_ITEM_CATEGORY_DATA_TABLE);
String dataInput = "txtCode: $('#txtCode').val(), txtName: $('#txtName').val()"; 
%>

<div class="contner" id='<%=dataTable != null ? dataTable.getId() : "dataTableNull"%>'></div>
