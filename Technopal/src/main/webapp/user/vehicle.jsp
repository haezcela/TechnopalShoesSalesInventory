...
<%@ page import="com.laponhcet.vehicle.*" %>

<%@ page import="com.mytechnopal.SessionInfo, com.mytechnopal.DataTable" %>

<%
SessionInfo sessionInfo = (SessionInfo) session.getAttribute(SessionInfo.SESSION_INFO);
DataTable dataTable = (DataTable)session.getAttribute(VehicleDTO.SESSION_VEHICLE_DATA_TABLE);
String dataInput = "cboVehicleTypeCode: $('#cboVehicleTypeCode').val(),txtPlateNumber: $('#txtPlateNumber').val()";
//String dataInput = "txtVehicleTypeCode: $('#txtVehicleTypeCode').val(),txtPlateNumber: $('#txtPlateNumber').val()"; 
%>
