...
DataTable dataTable = (DataTable)session.getAttribute(EventJudgeDTO.SESSION_EVENT_JUDGE_DATA_TABLE);
String dataInput = " txtCode: $('#txtCode').val(), cboEvent: $('#cboEvent').val(), cboJudge: $('#cboJudge').val()"; 
%>
