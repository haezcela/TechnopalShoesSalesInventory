...
String[] colorStr = new String[] {"#FAF9D0", "#ADD8E6", "#ff474c", "#50C878", "#FFFFF7"};
%>
 ...
 <div class="pt-5 mb-5">
	<div class="row">
   		<div class="col-lg-12 text-center">
   			...
   			<hr>
   			<button class="btn btn-primary" onclick="confirmTop5()">Confirm Top 5</button>	
   		</div>
   	</div>
</div>   	
