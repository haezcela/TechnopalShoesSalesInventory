...
<%@ page import="com.laponhcet.itemrequest.*" %>

<%
SessionInfo sessionInfo = (SessionInfo) session.getAttribute(SessionInfo.SESSION_INFO);
DataTable dataTable = (DataTable)session.getAttribute(ItemRequestDTO.SESSION_ITEM_REQUEST_DATA_TABLE);
String dataInput = "txtCode: $('#txtCode').val(), txtItemCode: $('#txtItemCode').val(), txtQuantity: $('#txtQuantity').val()"; 
%>
...
$.ajax({
url: 'UploadFileAjaxController?txtAction=' + action + '&txtFileId=' + fileId + '&txtName=' + name + '&txtFileType=' + fileType, 
type: 'POST',
