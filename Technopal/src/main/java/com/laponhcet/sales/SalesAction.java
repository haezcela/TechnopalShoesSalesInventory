...
public class SalesAction extends ActionBase {
    ...
    protected void setSessionVars() {
        ...
        dataTable.setColumnNameArr(new String[] {"Code", "Customer","Total", "Payment Status", "Status", "Total Amount Paid", "Date", "Actions"});
        dataTable.setColumnWidthArr(new String[] {"11","11", "11", "11", "11", "11", "11", "11", "12"}); 
