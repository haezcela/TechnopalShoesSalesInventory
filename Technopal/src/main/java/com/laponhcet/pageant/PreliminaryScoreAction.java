...
public class PreliminaryScoreAction extends ActionBase {
	private static final long serialVersionUID = 1L;

	protected void setSessionVars() {
		List<DTOBase> eventList = EventUtil.getEventListByEventTypeCode(new EventDAO().getEventList(), EventTypeDTO.EVENT_TYPE_CODE_PRELIMINARY);
