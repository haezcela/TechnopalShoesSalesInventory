...
public class PrePageantAction extends ActionBase {
	private static final long serialVersionUID = 1L;

	protected void setSessionVars() {
		setSessionAttribute(EventDTO.SESSION_EVENT_LIST, EventUtil.getEventListByEventTypeCode(new EventDAO().getEventList(), EventTypeDTO.EVENT_TYPE_CODE_PREPAGEANT));
