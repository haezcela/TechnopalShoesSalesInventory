...
public class PreliminaryActionAjax extends ActionAjaxBase {
	...
	protected void customAction(JSONObject jsonObj, String action) {
		...
		if(action.equalsIgnoreCase("SELECT EVENT")) {
			...
			String eventCriteriaCode = getRequestString("txtEventCriteriaCode");
			int score = getRequestInt("txtScore");
			
//			System.out.println("contestantCode: " + contestantCode);
//			System.out.println("eventCriteriaCode: " + eventCriteriaCode);
//			System.out.println("score: " + score);
			
			ContestantDTO contestant = (ContestantDTO) DTOUtil.getObjByCode(contestantList, contestantCode);
			EventCriteriaDTO eventCriteria = (EventCriteriaDTO) DTOUtil.getObjByCode(eventCriteriaList, eventCriteriaCode);
